...
#Embedded file name: otp\otpbase\OTPBase.py
...
def explorer():
    base.render.explore()
+++ okay decompyling C:\Users\dalma_000\Dropbox\TT Stuff\TTSC(new)\TTSC(new)\toontown\toontown2\otp\otpbase\OTPBase.pyc 
