...
#Embedded file name: otp\otpbase\OTPRender.py
...
+++ okay decompyling C:\Users\dalma_000\Dropbox\TT Stuff\TTSC(new)\TTSC(new)\toontown\toontown2\otp\otpbase\OTPRender.pyc 
