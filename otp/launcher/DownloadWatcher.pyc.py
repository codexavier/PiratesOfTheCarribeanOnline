...
#Embedded file name: otp\launcher\DownloadWatcher.py
...
class DownloadWatcher(DirectObject):
    ...
    def cleanup(self):
        ...
        self.bar.destroy()
        self.ignoreAll()
+++ okay decompyling C:\Users\dalma_000\Dropbox\TT Stuff\TTSC(new)\TTSC(new)\toontown\toontown2\otp\launcher\DownloadWatcher.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2014.05.21 01:51:56 Central Daylight Time
