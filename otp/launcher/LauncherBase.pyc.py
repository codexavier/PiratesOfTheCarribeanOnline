...
#Embedded file name: otp\launcher\LauncherBase.py
import sys
import os
import time
import string
...
class LauncherBase(DirectObject):
    ...
    def getDISLToken(self):
        ...
        if DISLToken == 'NO DISLTOKEN':
            DISLToken = None
        return DISLToken
+++ okay decompyling C:\Users\dalma_000\Dropbox\TT Stuff\TTSC(new)\TTSC(new)\toontown\toontown2\otp\launcher\LauncherBase.pyc 
