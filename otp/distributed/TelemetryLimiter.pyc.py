...
#Embedded file name: otp\distributed\TelemetryLimiter.py
...
+++ okay decompyling C:\Users\dalma_000\Dropbox\TT Stuff\TTSC(new)\TTSC(new)\toontown\toontown2\otp\distributed\TelemetryLimiter.pyc 
