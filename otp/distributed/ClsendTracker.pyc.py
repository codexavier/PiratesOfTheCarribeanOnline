...
#Embedded file name: otp\distributed\ClsendTracker.py
...
class ClsendTracker:
    ...
    def dumpClientSentMsgs(self):
        for msg in self._clsendMsgs:
            self._logClsend(*msg)
            self._clsendCounter += 1
+++ okay decompyling C:\Users\dalma_000\Dropbox\TT Stuff\TTSC(new)\TTSC(new)\toontown\toontown2\otp\distributed\ClsendTracker.pyc 
