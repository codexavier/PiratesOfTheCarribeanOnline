...
#Embedded file name: otp\avatar\PositionExaminer.py
...
class PositionExaminer(DirectObject, NodePath):
    ...
    def consider(self, node, pos, eyeHeight):
        ...
        return result
+++ okay decompyling C:\Users\dalma_000\Dropbox\TT Stuff\TTSC(new)\TTSC(new)\toontown\toontown2\otp\avatar\PositionExaminer.pyc 
