...
#Embedded file name: otp\avatar\DistributedPlayer.py
...
class DistributedPlayer(DistributedAvatar.DistributedAvatar, PlayerBase.PlayerBase, TelemetryLimited):
    ...
    def getAutoRun(self):
        return self.autoRun
+++ okay decompyling C:\Users\dalma_000\Dropbox\TT Stuff\TTSC(new)\TTSC(new)\toontown\toontown2\otp\avatar\DistributedPlayer.pyc 
