...
#Embedded file name: otp\avatar\ShadowCaster.py
...
+++ okay decompyling C:\Users\dalma_000\Dropbox\TT Stuff\TTSC(new)\TTSC(new)\toontown\toontown2\otp\avatar\ShadowCaster.pyc 
