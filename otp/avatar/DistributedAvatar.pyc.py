...
#Embedded file name: otp\avatar\DistributedAvatar.py
import time
import string
...
class DistributedAvatar(DistributedActor, Avatar):
    ...
    def getDialogueArray(self):
        return None
+++ okay decompyling C:\Users\dalma_000\Dropbox\TT Stuff\TTSC(new)\TTSC(new)\toontown\toontown2\otp\avatar\DistributedAvatar.pyc 
