...
#Embedded file name: otp\chat\ChatGlobals.py
import string
NORMAL_CHAT = 1
WHISPER_CHAT = 2
GUILD_CHAT = 3
...
def removeThoughtPrefix(message):
    if isThought(message):
        ...
        return message
+++ okay decompyling C:\Users\dalma_000\Dropbox\TT Stuff\TTSC(new)\TTSC(new)\toontown\toontown2\otp\chat\ChatGlobals.pyc 
