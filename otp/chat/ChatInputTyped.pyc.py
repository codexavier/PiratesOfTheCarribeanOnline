...
#Embedded file name: otp\chat\ChatInputTyped.py
...
class ChatInputTyped(DirectObject.DirectObject):
    ...
    def getNextHistory(self):
        ...
        self.historyIndex -= 1
        self.historyIndex %= len(self.history)
+++ okay decompyling C:\Users\dalma_000\Dropbox\TT Stuff\TTSC(new)\TTSC(new)\toontown\toontown2\otp\chat\ChatInputTyped.pyc 
