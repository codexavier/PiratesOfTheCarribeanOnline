...
#Embedded file name: otp\chat\TalkAssistant.py
import string
import sys
...
class TalkAssistant(DirectObject.DirectObject):
    ...
    def getWhisperReplyId(self):
        ...
        return (0, 0)
+++ okay decompyling C:\Users\dalma_000\Dropbox\TT Stuff\TTSC(new)\TTSC(new)\toontown\toontown2\otp\chat\TalkAssistant.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2014.05.21 01:51:44 Central Daylight Time
