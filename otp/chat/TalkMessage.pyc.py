...
#Embedded file name: otp\chat\TalkMessage.py
...
class TalkMessage:
    ...
    def setExtraInfo(self, extraInfo):
        self.extraInfo = extraInfo
+++ okay decompyling C:\Users\dalma_000\Dropbox\TT Stuff\TTSC(new)\TTSC(new)\toontown\toontown2\otp\chat\TalkMessage.pyc 
