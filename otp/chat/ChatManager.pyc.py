...
#Embedded file name: otp\chat\ChatManager.py
import string
import sys
...
class ChatManager(DirectObject.DirectObject):
    ...
    def __privacyPolicyDone(self):
        self.fsm.request('activateChat')
+++ okay decompyling C:\Users\dalma_000\Dropbox\TT Stuff\TTSC(new)\TTSC(new)\toontown\toontown2\otp\chat\ChatManager.pyc 
