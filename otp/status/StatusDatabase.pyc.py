...
#Embedded file name: otp\status\StatusDatabase.py
import datetime
import time
...
+++ okay decompyling C:\Users\dalma_000\Dropbox\TT Stuff\TTSC(new)\TTSC(new)\toontown\toontown2\otp\status\StatusDatabase.pyc 
