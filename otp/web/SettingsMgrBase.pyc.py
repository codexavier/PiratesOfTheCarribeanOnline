...
#Embedded file name: otp\web\SettingsMgrBase.py
...
+++ okay decompyling C:\Users\dalma_000\Dropbox\TT Stuff\TTSC(new)\TTSC(new)\toontown\toontown2\otp\web\SettingsMgrBase.pyc 
