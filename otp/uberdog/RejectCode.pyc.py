...
#Embedded file name: otp\uberdog\RejectCode.py
...
+++ okay decompyling C:\Users\dalma_000\Dropbox\TT Stuff\TTSC(new)\TTSC(new)\toontown\toontown2\otp\uberdog\RejectCode.pyc 
