...
#Embedded file name: otp\uberdog\OtpAvatarManagerAI.py
...
class OtpAvatarManagerAI(DistributedObjectAI):
    ...
    def shareAvatarResponse(self, todo0, todo1, todo2):
        pass
+++ okay decompyling C:\Users\dalma_000\Dropbox\TT Stuff\TTSC(new)\TTSC(new)\toontown\toontown2\otp\uberdog\OtpAvatarManagerAI.pyc 
