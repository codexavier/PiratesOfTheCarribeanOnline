...
#Embedded file name: otp\uberdog\OtpAvatarManager.py
...
class OtpAvatarManager(DistributedObject.DistributedObject):
    ...
    def playAvatarResponse(self, avatarId, subId, access, founder):
        messenger.send('playAvatarResponse', [avatarId,
         ...
         access,
         founder])
+++ okay decompyling C:\Users\dalma_000\Dropbox\TT Stuff\TTSC(new)\TTSC(new)\toontown\toontown2\otp\uberdog\OtpAvatarManager.pyc 
