...
#Embedded file name: otp\margins\WhisperPopup.py
...
class WhisperPopup(MarginPopup, ClickablePopup):
    ...
    def updateContents(self):
        ...
        balloon = NametagGlobals.speechBalloon2d.generate(self.text, self.font, textColor=fgColor, balloonColor=bgColor, wordWrap=self.WORDWRAP)
...
+++ okay decompyling C:\Users\dalma_000\Dropbox\TT Stuff\TTSC(new)\TTSC(new)\toontown\toontown2\otp\margins\WhisperPopup.pyc 
