...
#Embedded file name: otp\margins\MarginCell.py
...
class MarginCell(NodePath):
    ...
    def setDebug(self, status):
        ...
        if self.debugMode:
            ...
            self.debugSquare = None
+++ okay decompyling C:\Users\dalma_000\Dropbox\TT Stuff\TTSC(new)\TTSC(new)\toontown\toontown2\otp\margins\MarginCell.pyc 
