...
#Embedded file name: otp\level\DistributedLevel.py
...
class DistributedLevel(DistributedObject.DistributedObject, Level.Level):
    ...
    def complexVis(self):
        return 1
+++ okay decompyling C:\Users\dalma_000\Dropbox\TT Stuff\TTSC(new)\TTSC(new)\toontown\toontown2\otp\level\DistributedLevel.pyc 
