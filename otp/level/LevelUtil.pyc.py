...
#Embedded file name: otp\level\LevelUtil.py
import string
...
def getZoneNum2Node(levelModel, logFunc = lambda str: str):
    ...
    return zoneNum2node
+++ okay decompyling C:\Users\dalma_000\Dropbox\TT Stuff\TTSC(new)\TTSC(new)\toontown\toontown2\otp\level\LevelUtil.pyc 
