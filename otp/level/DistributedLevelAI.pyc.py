# 2014.05.21 01:52:00 Central Daylight Time
#Embedded file name: otp\level\DistributedLevelAI.py
...
class DistributedLevelAI(DistributedObjectAI.DistributedObjectAI, Level.Level):
    ...
    if __dev__:
        ...
        def saveSpec(self, task = None):
            ...
            self.modified = 0
+++ okay decompyling C:\Users\dalma_000\Dropbox\TT Stuff\TTSC(new)\TTSC(new)\toontown\toontown2\otp\level\DistributedLevelAI.pyc 
