...
#Embedded file name: otp\level\EntityTypes.py
...
class EntityGroup(Entity):
    type = 'entityGroup'
+++ okay decompyling C:\Users\dalma_000\Dropbox\TT Stuff\TTSC(new)\TTSC(new)\toontown\toontown2\otp\level\EntityTypes.pyc 
