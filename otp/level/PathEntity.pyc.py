...
#Embedded file name: otp\level\PathEntity.py
...
class PathEntity(BasicEntities.NodePathEntity):
    ...
    if __dev__:
        ...
        def setPathScale(self, pathScale):
            ...
            self.setPathIndex(self.pathIndex)
+++ okay decompyling C:\Users\dalma_000\Dropbox\TT Stuff\TTSC(new)\TTSC(new)\toontown\toontown2\otp\level\PathEntity.pyc 
