...
#Embedded file name: otp\level\DistributedInteractiveEntity.py
...
class DistributedInteractiveEntity(DistributedEntity.DistributedEntity):
    ...
    def exitPlaying(self):
        pass
+++ okay decompyling C:\Users\dalma_000\Dropbox\TT Stuff\TTSC(new)\TTSC(new)\toontown\toontown2\otp\level\DistributedInteractiveEntity.pyc 
