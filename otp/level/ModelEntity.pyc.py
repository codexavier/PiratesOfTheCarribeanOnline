...
#Embedded file name: otp\level\ModelEntity.py
...
class ModelEntity(BasicEntities.NodePathEntity):
    ...
    def setGoonHatType(self, goonHatType):
        ...
        self.loadModel()
+++ okay decompyling C:\Users\dalma_000\Dropbox\TT Stuff\TTSC(new)\TTSC(new)\toontown\toontown2\otp\level\ModelEntity.pyc 
