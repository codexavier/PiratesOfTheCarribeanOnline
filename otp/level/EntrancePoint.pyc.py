...
#Embedded file name: otp\level\EntrancePoint.py
...
class EntrancePoint(BasicEntities.NodePathEntity):
    ...
    if __dev__:
        ...
        def attribChanged(self, *args):
            ...
            self.destroyEntrancePoint()
            self.initEntrancePoint()
+++ okay decompyling C:\Users\dalma_000\Dropbox\TT Stuff\TTSC(new)\TTSC(new)\toontown\toontown2\otp\level\EntrancePoint.pyc 
