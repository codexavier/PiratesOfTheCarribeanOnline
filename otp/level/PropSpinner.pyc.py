...
#Embedded file name: otp\level\PropSpinner.py
import string
...
class PropSpinner(Entity):
    ...
    if __dev__:
        ...
        def attribChanged(self, *args):
            self.destroyProps()
            self.initProps()
+++ okay decompyling C:\Users\dalma_000\Dropbox\TT Stuff\TTSC(new)\TTSC(new)\toontown\toontown2\otp\level\PropSpinner.pyc 
