...
#Embedded file name: otp\level\EditMgrAI.py
import EditMgrBase
if __dev__:
...
+++ okay decompyling C:\Users\dalma_000\Dropbox\TT Stuff\TTSC(new)\TTSC(new)\toontown\toontown2\otp\level\EditMgrAI.pyc 
