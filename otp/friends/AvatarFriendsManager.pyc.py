...
#Embedded file name: otp\friends\AvatarFriendsManager.py
...
class AvatarFriendsManager(DistributedObjectGlobal):
    ...
    def countTrueFriends(self):
        ...
        return count
+++ okay decompyling C:\Users\dalma_000\Dropbox\TT Stuff\TTSC(new)\TTSC(new)\toontown\toontown2\otp\friends\AvatarFriendsManager.pyc 
