...
#Embedded file name: otp\friends\PlayerFriendsManager.py
...
+++ okay decompyling C:\Users\dalma_000\Dropbox\TT Stuff\TTSC(new)\TTSC(new)\toontown\toontown2\otp\friends\PlayerFriendsManager.pyc 
