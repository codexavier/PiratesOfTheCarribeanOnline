...
#Embedded file name: otp\friends\GuildManagerUD.py
...
class GuildManagerUD(DistributedObjectUD):
    ...
    def avatarDeleted(self, todo0):
        pass
+++ okay decompyling C:\Users\dalma_000\Dropbox\TT Stuff\TTSC(new)\TTSC(new)\toontown\toontown2\otp\friends\GuildManagerUD.pyc 
