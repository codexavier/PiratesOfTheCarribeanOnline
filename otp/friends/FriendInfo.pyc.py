...
#Embedded file name: otp\friends\FriendInfo.py
...
+++ okay decompyling C:\Users\dalma_000\Dropbox\TT Stuff\TTSC(new)\TTSC(new)\toontown\toontown2\otp\friends\FriendInfo.pyc 
