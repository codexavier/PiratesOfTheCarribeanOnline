# 2014.05.21 01:51:53 Central Daylight Time
#Embedded file name: otp\friends\FriendSecret.py
...
class FriendSecret(DirectFrame, StateData.StateData):
    ...
    def __cleanupFirstPage(self):
        ...
        self.enterSecret.hide()
        base.localAvatar.chatMgr.fsm.request('mainMenu')
+++ okay decompyling C:\Users\dalma_000\Dropbox\TT Stuff\TTSC(new)\TTSC(new)\toontown\toontown2\otp\friends\FriendSecret.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2014.05.21 01:51:54 Central Daylight Time
