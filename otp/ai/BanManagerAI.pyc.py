...
#Embedded file name: otp\ai\BanManagerAI.py
import urllib
import os
...
class BanManagerAI:
    ...
    def doBanUrlTask(self, task):
        ...
        self.cleanupBanReq(banReq)
        return task.done
+++ okay decompyling C:\Users\dalma_000\Dropbox\TT Stuff\TTSC(new)\TTSC(new)\toontown\toontown2\otp\ai\BanManagerAI.pyc 
