# 2014.05.21 01:37:27 Central Daylight Time
#Embedded file name: otp\ai\Barrier.py
...
class Barrier(DirectObject.DirectObject):
    ...
    def __handleUnexpectedExit(self, avId):
        ...
        if avId in self.pendingAvatars:
            self.clear(avId)
+++ okay decompyling C:\Users\dalma_000\Dropbox\TT Stuff\TTSC(new)\TTSC(new)\otp\ai\Barrier.pyc 
