...
#Embedded file name: otp\ai\MagicWordGlobal.py
...
+++ okay decompyling C:\Users\dalma_000\Dropbox\TT Stuff\TTSC(new)\TTSC(new)\toontown\toontown2\otp\ai\MagicWordGlobal.pyc 
