# 2014.05.21 01:51:33 Central Daylight Time
#Embedded file name: otp\ai\TimeManagerAI.py
...
class TimeManagerAI(DistributedObjectAI):
    ...
    def checkAvOnDistrict(self, todo0, todo1):
        pass
+++ okay decompyling C:\Users\dalma_000\Dropbox\TT Stuff\TTSC(new)\TTSC(new)\toontown\toontown2\otp\ai\TimeManagerAI.pyc 
