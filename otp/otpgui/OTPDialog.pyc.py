...
#Embedded file name: otp\otpgui\OTPDialog.py
...
class GlobalDialog(OTPDialog):
    ...
    def handleButton(self, value):
        if value == DGG.DIALOG_OK:
            ...
            messenger.send(self.__doneEvent)
+++ okay decompyling C:\Users\dalma_000\Dropbox\TT Stuff\TTSC(new)\TTSC(new)\toontown\toontown2\otp\otpgui\OTPDialog.pyc 
