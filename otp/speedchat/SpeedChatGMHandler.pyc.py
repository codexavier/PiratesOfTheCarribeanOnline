...
#Embedded file name: otp\speedchat\SpeedChatGMHandler.py
...
+++ okay decompyling C:\Users\dalma_000\Dropbox\TT Stuff\TTSC(new)\TTSC(new)\toontown\toontown2\otp\speedchat\SpeedChatGMHandler.pyc 
