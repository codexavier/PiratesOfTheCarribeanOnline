...
#Embedded file name: otp\speedchat\SCObject.py
...
class SCObject(DirectObject):
    ...
    def finalizeAll(self):
        self.finalize()
+++ okay decompyling C:\Users\dalma_000\Dropbox\TT Stuff\TTSC(new)\TTSC(new)\toontown\toontown2\otp\speedchat\SCObject.pyc 
