...
#Embedded file name: otp\speedchat\SCTerminal.py
...
class SCTerminal(SCElement):
    ...
    def getDisplayText(self):
        if self.getCharges() is not -1:
            ...
            return self.text
+++ okay decompyling C:\Users\dalma_000\Dropbox\TT Stuff\TTSC(new)\TTSC(new)\toontown\toontown2\otp\speedchat\SCTerminal.pyc 
