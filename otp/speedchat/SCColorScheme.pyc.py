...
#Embedded file name: otp\speedchat\SCColorScheme.py
...
class SCColorScheme:
    ...
    def __repr__(self):
        return str(self)
+++ okay decompyling C:\Users\dalma_000\Dropbox\TT Stuff\TTSC(new)\TTSC(new)\toontown\toontown2\otp\speedchat\SCColorScheme.pyc 
