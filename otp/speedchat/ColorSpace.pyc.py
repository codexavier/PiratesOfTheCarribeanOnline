...
#Embedded file name: otp\speedchat\ColorSpace.py
import math
...
+++ okay decompyling C:\Users\dalma_000\Dropbox\TT Stuff\TTSC(new)\TTSC(new)\toontown\toontown2\otp\speedchat\ColorSpace.pyc 
