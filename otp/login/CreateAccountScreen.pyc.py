...
#Embedded file name: otp\login\CreateAccountScreen.py
...
class CreateAccountScreen(StateData.StateData, GuiScreen.GuiScreen):
    ...
    def __handleBadWordInUserName(self):
        ...
        self.dialog.hide()
        self.fsm.request('create')
+++ okay decompyling C:\Users\dalma_000\Dropbox\TT Stuff\TTSC(new)\TTSC(new)\toontown\toontown2\otp\login\CreateAccountScreen.pyc 
