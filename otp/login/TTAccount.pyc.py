# 2014.05.21 01:38:10 Central Daylight Time
#Embedded file name: otp\login\TTAccount.py
...
if not accountServer:
    accountServer = 'http://toontownrevolution.com/'
...
class TTAccount:
    ...
    def authenticateParentUsernameAndPassword(self, loginName, password, parentUsername, parentPassword):
        try:
            ...
            return (0, str(e))
+++ okay decompyling C:\Users\dalma_000\Dropbox\TT Stuff\TTSC(new)\TTSC(new)\otp\login\TTAccount.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2014.05.21 01:38:11 Central Daylight Time
