...
#Embedded file name: otp\login\LeaveToPayDialog.py
...
class LeaveToPayDialog:
    ...
    def __handleLeaveToPayCancel(self):
        if self.doneFunc:
            self.doneFunc()
        self.destroy()
+++ okay decompyling C:\Users\dalma_000\Dropbox\TT Stuff\TTSC(new)\TTSC(new)\toontown\toontown2\otp\login\LeaveToPayDialog.pyc 
