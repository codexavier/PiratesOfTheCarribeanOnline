...
#Embedded file name: otp\login\GuiScreen.py
...
+++ okay decompyling C:\Users\dalma_000\Dropbox\TT Stuff\TTSC(new)\TTSC(new)\toontown\toontown2\otp\login\GuiScreen.pyc 
