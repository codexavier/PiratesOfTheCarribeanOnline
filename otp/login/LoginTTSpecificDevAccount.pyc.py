...
#Embedded file name: otp\login\LoginTTSpecificDevAccount.py
...
class LoginTTSpecificDevAccount(LoginTTAccount.LoginTTAccount):
    ...
    def needToSetParentPassword(self):
        return False
+++ okay decompyling C:\Users\dalma_000\Dropbox\TT Stuff\TTSC(new)\TTSC(new)\otp\login\LoginTTSpecificDevAccount.pyc 
