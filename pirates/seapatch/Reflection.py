...
class Reflection(DirectObject):
    ...
    getGlobalReflection = classmethod(getGlobalReflection)
    ...
    getSkyOnly = classmethod(getSkyOnly)
    ...
    uninitialize = classmethod(uninitialize)
    ...
    def __init__(self, name, width, height, parent, plane = Plane(Vec3(0, 0, 1), Point3(0, 0, 0))):
        ...
        self._Reflection__createBuffer()
        self.accept('close_main_window', self._Reflection__destroyBuffer)
        self.accept('open_main_window', self._Reflection__createBuffer)
        self.accept('texture_state_changed', self._Reflection__createBuffer)

    
    def _Reflection__destroyBuffer(self):
    ...
    def _Reflection__createBuffer(self):
        self._Reflection__destroyBuffer()
