...
class HumanBase:
    ...
    def d_setHeadRoundness(self, val):
        self.sendUpdate('setHeadRoundness', [
            val])
    ...
    def d_setJawRoundness(self, val):
        self.sendUpdate('setJawRoundness', [
            val])
    ...
    def d_setMouthLipThickness(self, val):
        self.sendUpdate('setMouthLipThickness', [
            val])
    ...
    def d_setCheekBoneHeight(self, val):
        self.sendUpdate('setCheekBoneHeight', [
            val])
    ...
    def d_setCheekBoneWidth(self, val):
        self.sendUpdate('setCheekBoneWidth', [
            val])
