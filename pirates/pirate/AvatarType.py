...
class AvatarType:
    ...
    def __init__(self, faction = None, track = None, id = None, base = None, boss = 0):
        ...
        self._AvatarType__bossType = None
        self._setMutable(False)


    def _setMutable(self, mutable):
        self._AvatarType__mutable = mutable
    ...
    def __eq__(self, other):
        ...
        if self.faction == other.faction and self.track == other.track and self.id == other.id:
            pass
        return self.boss == other.boss
    ...
    def __ne__(self, other):
        ...
        if not self.faction != other.faction and self.track != other.track and self.id != other.id:
            pass
        return self.boss != other.boss
    ...
    def getBossType(self):
        if not self._AvatarType__bossType:
            self._setMutable(True)
            self._AvatarType__bossType = AvatarType(base = self, boss = 1)
            self._setMutable(False)

        return self._AvatarType__bossType
    ...
    def getNonBossType(self):
        ...
        if not self._AvatarType__bossType:
            self._setMutable(True)
            self._AvatarType__bossType = AvatarType(base = self, boss = False)
            self._setMutable(False)
