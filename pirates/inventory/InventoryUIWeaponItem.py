...
itemBrown.setTextColor(0.52500000000000002, 0.3125, 0.087499999999999994, 1)
itemBrown.setShadowColor(PiratesGuiGlobals.TextShadow)
itemBrown.setShadow(0.059999999999999998, 0.059999999999999998)
...
itemYellow.setShadow(0.059999999999999998, 0.059999999999999998)
tpMgr.setProperties('itemYellow', itemYellow)
itemGreen = TextProperties()
itemGreen.setSmallCaps(1)
itemGreen.setTextColor(0, 0.40000000000000002, 0, 1)
itemGreen.setShadowColor(PiratesGuiGlobals.TextShadow)
itemGreen.setShadow(0.059999999999999998, 0.059999999999999998)
tpMgr.setProperties('itemGreen', itemGreen)
itemBlue = TextProperties()
itemBlue.setSmallCaps(1)
itemBlue.setTextColor(0.23999999999999999, 0.35999999999999999, 0.59999999999999998, 1)
itemBlue.setShadowColor(PiratesGuiGlobals.TextShadow)
itemBlue.setShadow(0.059999999999999998, 0.059999999999999998)
tpMgr.setProperties('itemBlue', itemBlue)
itemRed = TextProperties()
itemRed.setSmallCaps(1)
itemRed.setTextColor(0.40000000000000002, 0, 0, 1)
itemRed.setShadowColor(PiratesGuiGlobals.TextShadow)
itemRed.setShadow(0.059999999999999998, 0.059999999999999998)
