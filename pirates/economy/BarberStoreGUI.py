...
class BarberStoreGUI(DirectFrame):
    ...
    def aspectRatioChange(self):
        ...
        height = 0.10000000000000001 * aspect2d.getScale()[2]
        offsetX = 0.20000000000000001 * aspect2d.getScale()[0]
    ...
    def setPage(self, pageName, startIndex = 0):
        self.tabBar.unstash()
        self.titleLabel['text'] = 'smallCaps' + self.rootTitle + ' - ' + PLocalizer.barberNames.get(pageName)
        ...
        for x in range(len(regionData)):
            ...
            if pageName == BarberGlobals.HAIR:
                if gender == 'f':
                    ...
                    offsetZ = -headPos * 1.0700000000000001
            elif pageName == BarberGlobals.BEARD:
                offsetZ = -headPos * 1.0
            elif pageName == BarberGlobals.MUSTACHE:
