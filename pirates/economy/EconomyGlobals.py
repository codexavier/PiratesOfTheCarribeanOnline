...
OVERHAUL_COST_PERCENTAGE = 0.40000000000000002
...
__itemList = {
    ...
    ItemId.VENOMSHOT: (0.14999999999999999, ItemType.AMMO, ItemType.PISTOLAMMO, None, 25, 0, None),
    ItemId.IRONSHOT: (0.20000000000000001, ItemType.AMMO, ItemType.PISTOLAMMO, None, 25, 0, None),
    ItemId.GOLDENSHOT: (0.25, ItemType.AMMO, ItemType.PISTOLAMMO, None, 25, 0, None),
    ItemId.SILVERSHOT: (0.29999999999999999, ItemType.AMMO, ItemType.PISTOLAMMO, None, 25, 0, None),
    ItemId.STEELSHOT: (0.34999999999999998, ItemType.AMMO, ItemType.PISTOLAMMO, None, 25, 0, None),
    ItemId.ASP_DAGGER: (0.14999999999999999, ItemType.AMMO, ItemType.DAGGERAMMO, None, 25, 0, None),
    ItemId.ADDER_DAGGER: (0.29999999999999999, ItemType.AMMO, ItemType.DAGGERAMMO, None, 25, 0, None),
    ItemId.SIDEWINDER_DAGGER: (0.45000000000000001, ItemType.AMMO, ItemType.DAGGERAMMO, None, 25, 0, None),
    ItemId.VIPERNEST_DAGGER: (1.5, ItemType.AMMO, ItemType.DAGGERAMMO, None, 5, 0, None),
    ItemId.EXPLOSION_G: (0.40000000000000002, ItemType.AMMO, ItemType.GRENADEAMMO, None, 25, 0, None),
    ItemId.SHOCKBOMB_G: (0.5, ItemType.AMMO, ItemType.GRENADEAMMO, None, 10, 0, None),
    ItemId.FLAME_G: (0.59999999999999998, ItemType.AMMO, ItemType.GRENADEAMMO, None, 10, 0, None),
    ...
    ItemId.CHAIN_SHOT: (0.14999999999999999, ItemType.AMMO, ItemType.CANNONAMMO, None, 25, 0, None),
    ItemId.GRAPE_SHOT: (0.20000000000000001, ItemType.AMMO, ItemType.CANNONAMMO, None, 25, 0, None),
    ItemId.FIREBRAND: (0.5, ItemType.AMMO, ItemType.CANNONAMMO, None, 25, 0, None),
    ItemId.THUNDERBOLT: (0.59999999999999998, ItemType.AMMO, ItemType.CANNONAMMO, None, 25, 0, None),
    ItemId.EXPLOSIVE: (15, ItemType.AMMO, ItemType.CANNONAMMO, None, 1, 0, None),
    ItemId.FURY: (0.80000000000000004, ItemType.AMMO, ItemType.CANNONAMMO, None, 25, 0, None),
    ItemId.GRAPPLE_HOOK: (0.20000000000000001, ItemType.AMMO, ItemType.CANNONAMMO, None, 25, 0, None),
    ItemId.BULLET: (0.20000000000000001, ItemType.AMMO, ItemType.CANNONAMMO, None, 25, 0, None),
    ItemId.GAS_CLOUD: (0.20000000000000001, ItemType.AMMO, ItemType.CANNONAMMO, None, 25, 0, None),
    ItemId.SKULL_AMMO: (0.29999999999999999, ItemType.AMMO, ItemType.CANNONAMMO, None, 25, 0, None),
    ItemId.FLAME_CLOUD: (0.29999999999999999, ItemType.AMMO, ItemType.CANNONAMMO, None, 25, 0, None),
    ItemId.FLAMING_SKULL: (0.29999999999999999, ItemType.AMMO, ItemType.CANNONAMMO, None, 25, 0, None),
    ItemId.BAR_SHOT: (0.40000000000000002, ItemType.AMMO, ItemType.CANNONAMMO, None, 25, 0, None),
    ItemId.KNIVES: (0.40000000000000002, ItemType.AMMO, ItemType.CANNONAMMO, None, 25, 0, None),
