...
class AccessoriesStoreTabBar(TabBar):
    ...
    def makeTab(self, name, **kw):
        return AccessoriesStoreTab(self, name, **None)
...
class AccessoriesStoreCartList(DirectScrolledFrame):
    ...
    def addPanel(self, data, mode, repack = 1):
        ...
        panel = DirectButton(parent = self, relief = None, text = text[:maxLength], text_fg = self.itemColor, text_align = TextNode.ALeft, text_scale = PiratesGuiGlobals.TextScaleMed, text_shadow = PiratesGuiGlobals.TextShadow, text_pos = (0.059999999999999998, 0.0), command = self.removePanel, extraArgs = [
            data,
            mode])
        panel.costLabel = DirectLabel(parent = panel, relief = None, text = strCost, text_fg = self.itemColor, text_align = TextNode.ARight, text_scale = PiratesGuiGlobals.TextScaleMed, text_shadow = PiratesGuiGlobals.TextShadow, text_pos = (0.45000000000000001, 0.0), image = self.parent.CoinImage, image_scale = 0.14999999999999999, image_pos = (0.47999999999999998, 0.0, 0.014))
...
class AccessoriesStoreGUI(DirectFrame):
    ...
    def __init__(self, npc, shopId, **kw):
        ...
        self.categoryText = [
            ...
            [
                PLocalizer.Shoe,
                PLocalizer.Shoes]]
        self.buyParchment = DirectFrame(parent = self.cartFrame, relief = None, text = PLocalizer.TailorPurchase, text_fg = PiratesGuiGlobals.TextFG1, text_align = TextNode.ACenter, text_scale = PiratesGuiGlobals.TextScaleLarge, text_pos = (0.0, 0.20000000000000001), text_shadow = PiratesGuiGlobals.TextShadow, textMayChange = 0, image = self.ParchmentIcon, image_scale = (0.23999999999999999, 0.0, 0.29999999999999999), image_pos = (0.0, 0.0, 0.0), pos = (0.29999999999999999, 0.0, 0.92000000000000004))
        self.sellParchment = DirectFrame(parent = self.cartFrame, relief = None, text = PLocalizer.TailorSelling, text_fg = PiratesGuiGlobals.TextFG1, text_align = TextNode.ACenter, text_scale = PiratesGuiGlobals.TextScaleLarge, text_pos = (0.0, 0.20000000000000001), text_shadow = PiratesGuiGlobals.TextShadow, textMayChange = 0, image = self.ParchmentIcon, image_scale = (0.23999999999999999, 0.0, 0.29999999999999999), image_pos = (0.0, 0.0, 0.0), pos = (0.29999999999999999, 0.0, 0.47999999999999998))
        self.purchaseInventory = AccessoriesStoreCartList(self, self.cartWidth, self.cartHeight - 0.94999999999999996, self.cartWidth, self.cartHeight / 20.0)
        self.purchaseInventory.reparentTo(self.cartFrame)
        self.purchaseInventory.setPos(0.0, 0.0, 0.76000000000000001)
        self.sellInventory = AccessoriesStoreCartList(self, self.cartWidth, self.cartHeight - 0.94999999999999996, self.cartWidth, self.cartHeight / 20.0)
        ...
        self.balanceTitle = DirectFrame(parent = self.cartFrame, relief = None, text = PLocalizer.Total, text_fg = PiratesGuiGlobals.TextFG2, text_align = TextNode.ALeft, text_scale = PiratesGuiGlobals.TextScaleLarge, text_pos = (0.0, 0.0), text_shadow = PiratesGuiGlobals.TextShadow, pos = (0.089999999999999997, 0, 0.22500000000000001))
        self.balanceValue = DirectFrame(parent = self.cartFrame, relief = None, text = str(self.balance), text_fg = PiratesGuiGlobals.TextFG2, text_align = TextNode.ARight, text_scale = PiratesGuiGlobals.TextScaleLarge, text_pos = (-0.055, 0.0), text_shadow = PiratesGuiGlobals.TextShadow, textMayChange = 1, image = currencyIcon, image_scale = 0.14999999999999999, image_pos = (-0.025000000000000001, 0, 0.014999999999999999), pos = (self.cartWidth, 0, 0.22500000000000001))
        self.myGoldTitle = DirectFrame(parent = self.cartFrame, relief = None, text = yourMoney, text_fg = PiratesGuiGlobals.TextFG2, text_align = TextNode.ALeft, text_scale = PiratesGuiGlobals.TextScaleLarge, text_pos = (0.0, 0.0), text_shadow = PiratesGuiGlobals.TextShadow, pos = (0.089999999999999997, 0, 0.155))
        self.myGold = DirectFrame(parent = self.cartFrame, relief = None, text = str(self.getMoney()), text_fg = PiratesGuiGlobals.TextFG2, text_align = TextNode.ARight, text_scale = PiratesGuiGlobals.TextScaleLarge, text_pos = (-0.055, 0.0), text_shadow = PiratesGuiGlobals.TextShadow, textMayChange = 1, image = currencyIcon, image_scale = 0.14999999999999999, image_pos = (-0.025000000000000001, 0, 0.014999999999999999), pos = (self.cartWidth, 0, 0.155))
        ...
        self.commitButton.setPos(self.cartWidth / 2, 0, 0.0050000000000000001)
        ...
        self.closeButton.setPos(self.cartWidth / 2 - 0.55000000000000004, 0, 0.0050000000000000001)
        ...
        self.redeemCodeButton.setPos(-0.014999999999999999, 0, 0.0050000000000000001)
        self.storeButton = DialogButton.DialogButton(command = self.changeMode, state = DGG.DISABLED, parent = self.cartFrame, text = PLocalizer.InteractStore, text_fg = PiratesGuiGlobals.TextFG2, text_scale = PiratesGuiGlobals.TextScaleLarge, text_shadow = PiratesGuiGlobals.TextShadow, image_color = Vec4(0.69999999999999996, 0.94999999999999996, 0.69999999999999996, 1.0), scale = 0.90000000000000002, extraArgs = [
            0])
        self.storeButton.setPos(-0.40000000000000002, 0.0, 1.1499999999999999)
        self.wardrobeButton = DialogButton.DialogButton(command = self.changeMode, state = DGG.NORMAL, parent = self.cartFrame, text = PLocalizer.TailorWardrobe, text_fg = PiratesGuiGlobals.TextFG2, text_scale = PiratesGuiGlobals.TextScaleLarge, text_shadow = PiratesGuiGlobals.TextShadow, image_color = Vec4(0.94999999999999996, 0.69999999999999996, 0.69999999999999996, 1.0), scale = 0.90000000000000002, extraArgs = [
            1])
        self.wardrobeButton.setPos(-0.17999999999999999, 0.0, 1.1499999999999999)
        tGui = loader.loadModel('models/gui/triangle')
        triangle = (tGui.find('**/triangle'), tGui.find('**/triangle_down'), tGui.find('**/triangle_over'))
        self.nextPageButton = DirectButton(parent = self.panel, relief = None, state = DGG.DISABLED, image = triangle, image_scale = 0.065000000000000002, pos = (0.53000000000000003, 0.0, 0.17499999999999999), rolloverSound = None, command = self.nextPage)
        self.prevPageButton = DirectButton(parent = self.panel, relief = None, state = DGG.DISABLED, image = triangle, image_scale = -0.065000000000000002, pos = (0.17000000000000001, 0.0, 0.17499999999999999), rolloverSound = None, command = self.previousPage)
        self.pageNumber = DirectFrame(parent = self.panel, relief = None, text = '', text_fg = PiratesGuiGlobals.TextFG2, text_align = TextNode.ACenter, text_scale = PiratesGuiGlobals.TextScaleLarge, text_pos = (0.0, 0.0), text_shadow = PiratesGuiGlobals.TextShadow, pos = (0.34999999999999998, 0, 0.16250000000000001))
    ...
    def showColorFrame(self, button = None, type = None, id = None, tex = None, cost = None, uid = None):
        if not self.colorFrame:
            ...
            gui_main.removeNode()
            self.colorFrame = DirectFrame(parent = aspect2dp, relief = None, image = topImage, image_scale = (0.23999999999999999, 0.23999999999999999, 0.23999999999999999), pos = (0.10000000000000001, 0.0, -0.20000000000000001))
            ...
            self.selectColorButton = GuiButton.GuiButton(parent = self.colorFrame, state = DGG.DISABLED, text = PLocalizer.lConfirm, pos = (0.38500000000000001, 0.0, -0.025000000000000001), command = self.confirmColorSelect)
        ...
        self.cancelColorButton = GuiButton.GuiButton(parent = self.colorFrame, text = PLocalizer.lCancel, pos = (0.65000000000000002, 0.0, -0.025000000000000001), command = exitFrame)
        ...
        for idx in range(0, len(colorSet)):
            ...
            colorFrame = DirectFrame(parent = colorButton, frameSize = (-0.032500000000000001, 0.032500000000000001, -0.032500000000000001, 0.032500000000000001))
            colorButton['extraArgs'] = [
                color,
                colorButton]
            colorFrame['frameColor'] = DYE_COLORS[color]
            offsetx += 0.10000000000000001
            if idx != 0 and (idx + 1) % 7 == 0:
                offsetx = 0.22
                offsety -= 0.089999999999999997
    ...
    def aspectRatioChange(self):
        ...
        ar = float(x) / float(y)
        width = 0.10000000000000001 * aspect2d.getScale()[0]
        height = 0.074999999999999997 * aspect2d.getScale()[2]
        offsetX = 0.13 * aspect2d.getScale()[0]
        offsetY = -0.014999999999999999 * aspect2d.getScale()[2]
    ...
    def focusCamera(self, cameraId = BODY_CAMERA):
        ...
        if cameraId == BODY_CAMERA:
            dummy.lookAt(self.pirate, self.pirate.headNode.getX(self.pirate), self.pirate.headNode.getY(self.pirate), self.pirate.headNode.getZ(self.pirate) * 0.90000000000000002)
        else:
            return None
        dummy.setH(dummy, -17)
        dummy.setP(dummy, -12)
    ...
    def addTab(self, id):
        ...
        if id == ClothingGlobals.HAT:
            ...
            tabIcon = None
            tabScale = 0.0
        newTab.nameTag = DirectLabel(parent = newTab, relief = None, state = DGG.DISABLED, pos = (0.059999999999999998, 0, -0.035000000000000003), image = tabIcon, image_scale = tabScale)
    ...
    def setPage(self, pageName, startIndex = 0, refreshWardrobe = True):
        self.tabBar.unstash()
        self.titleLabel['text'] = 'smallCaps' + self.rootTitle + ' - ' + self.categoryText[pageName][1]
        ...
        if self.mode == BUYING:
            ...
            buttonColorA = Vec4(0.69999999999999996, 0.94999999999999996, 0.69999999999999996, 1.0)
            buttonColorB = Vec4(0.40000000000000002, 0.65000000000000002, 0.40000000000000002, 1.0)
            self.purchaseInventory.setItemColor(Vec4(0.29999999999999999, 0.94999999999999996, 0.29999999999999999, 1.0))
        elif self.mode == SELLING:
        ...
        for cloth in clothes:
            ...
            if numButtons < self.buttonsPerPage and self.clothingAmount >= startIndex:
                ...
                if self.mode == BUYING and not owned:
                    clothButton.previewText = DirectFrame(parent = clothButton, relief = None, text = PLocalizer.TailorPreview, text_fg = PiratesGuiGlobals.TextFG1, text_align = TextNode.ARight, text_scale = PiratesGuiGlobals.TextScaleSmall, text_shadow = PiratesGuiGlobals.TextShadow, textMayChange = 1, pos = (-0.02, 0, -0.080000000000000002))
                elif self.mode == SELLING:
                    clothButton.equippedText = DirectFrame(parent = clothButton, relief = None, text = PLocalizer.TattooShopOwned, text_fg = PiratesGuiGlobals.TextFG1, text_align = TextNode.ARight, text_scale = PiratesGuiGlobals.TextScaleSmall, text_shadow = PiratesGuiGlobals.TextShadow, textMayChange = 0, pos = (-0.02, 0, -0.080000000000000002))
                    if equipped:
                        clothButton.equippedText.show()
                    else:
                        clothButton.equippedText.hide()

                clothButton.addToCart = GuiButton.GuiButton(command = self.addToCart, parent = clothButton, text_fg = PiratesGuiGlobals.TextFG2, text_pos = (0.0, -0.01), text_scale = PiratesGuiGlobals.TextScaleLarge, text_align = TextNode.ACenter, text_shadow = PiratesGuiGlobals.TextShadow, image_color = buttonColorB, image_scale = (0.19, 0.22, 0.22), pos = (0.17999999999999999, 0.0, 0.055), helpText = PLocalizer.ShopAddToCart, helpDelay = 0)
                clothButton.colorPicker = GuiButton.GuiButton(command = self.showColorFrame, parent = clothButton, text_fg = PiratesGuiGlobals.TextFG2, text_pos = (0.0, -0.01), text_scale = PiratesGuiGlobals.TextScaleLarge, text_align = TextNode.ACenter, text_shadow = PiratesGuiGlobals.TextShadow, image_color = buttonColorB, image_scale = (0.080000000000000002, 0.22, 0.22), geom = self.ColorPickerIcon, geom_scale = 0.40000000000000002, geom_color = Vec4(0.80000000000000004, 0.80000000000000004, 0.80000000000000004, 1), pos = (0.044999999999999998, 0.0, 0.055), helpText = PLocalizer.ShopSelectColor, helpPos = (-0.28000000000000003, 0, 0.080000000000000002), helpDelay = 0, helpOpaque = 1)
                if self.mode == BUYING:
                ...
                if self.mode == BUYING and not owned:
                    ...
                    if self.pvpMode or landInfamyRequired or seaInfamyRequired:
                        ...
                        clothButton['text_pos'] = (-0.02, 0.050000000000000003)
                    ...
                    if original:
                        ...
                        clothButton.addToCart.hide()
                        clothButton.originalItem = DirectFrame(parent = clothButton, relief = None, text = PLocalizer.TailorStartingItem, text_fg = PiratesGuiGlobals.TextFG2, text_align = TextNode.ACenter, text_scale = PiratesGuiGlobals.TextScaleLarge, text_shadow = PiratesGuiGlobals.TextShadow, textMayChange = 0, pos = (0.16, 0.0, 0.040000000000000001))


                if not self.paid:
                    clothButton.addToCart['geom'] = self.LockIcon
                    clothButton.addToCart['geom_scale'] = 0.20000000000000001
                    clothButton.addToCart['geom_pos'] = Vec3(-0.10000000000000001, 0.0, 0.0)
    ...
    def setupDisplayRegions(self, regionData, pageName):
        ...
        for x in range(len(regionData)):
            if pageName == ClothingGlobals.HAT:
                ...
                offsetZ = -headHeight - 0.40000000000000002
                ...
                offsetZ = -ankleHeight - 0.14999999999999999
                offsetY = 3.25 + bodyOffset
                offsetH = 200
            else:
                offsetZ = 0
