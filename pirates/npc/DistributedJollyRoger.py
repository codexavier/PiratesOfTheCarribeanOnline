...
class DistributedJollyRoger(DistributedBattleNPC.DistributedBattleNPC, JollyRoger.JollyRoger, Boss):
    ...
    def play(self, *args, **kwArgs):
        JollyRoger.JollyRoger.play(self, *args, **args)

    
    def loop(self, *args, **kwArgs):
        JollyRoger.JollyRoger.loop(self, *args, **args)

    
    def pose(self, *args, **kwArgs):
        JollyRoger.JollyRoger.pose(self, *args, **args)

    
    def pingpong(self, *args, **kwArgs):
        JollyRoger.JollyRoger.pingpong(self, *args, **args)

    
    def stop(self, *args, **kwArgs):
        JollyRoger.JollyRoger.stop(self, *args, **args)
