...
class DistributedBomberZombie(DistributedBattleNPC.DistributedBattleNPC, BomberZombie.BomberZombie):
    ...
    def play(self, *args, **kwArgs):
        BomberZombie.BomberZombie.play(self, *args, **args)

    
    def loop(self, *args, **kwArgs):
        BomberZombie.BomberZombie.loop(self, *args, **args)

    
    def pose(self, *args, **kwArgs):
        BomberZombie.BomberZombie.pose(self, *args, **args)

    
    def pingpong(self, *args, **kwArgs):
        BomberZombie.BomberZombie.pingpong(self, *args, **args)

    
    def stop(self, *args, **kwArgs):
        BomberZombie.BomberZombie.stop(self, *args, **args)
