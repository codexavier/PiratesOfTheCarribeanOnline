...
MainWorldInvulnerabilityCutoffRadiusScale = StateVarSetting('pvp.invulnerability.cutoffSphereRadiusScale', 1.1000000000000001)
...
ShipClass2repairLocators = {
    ...
    ShipGlobals.EL_PATRONS_SHIP: StateVarSetting(repairSpotNamePrefix + 'el_patrons_ship', [
        0,
        1,
        2,
        3]),
    ShipGlobals.P_NAVY_KINGFISHER: StateVarSetting(repairSpotNamePrefix + 'p_navy_kingfisher', [
        0,
        1,
        2,
        3]),
    ShipGlobals.P_EITC_WARLORD: StateVarSetting(repairSpotNamePrefix + 'p_eitc_warlord', [
        0,
        1,
        2,
        3]),
    ShipGlobals.P_SKEL_PHANTOM: StateVarSetting(repairSpotNamePrefix + 'p_skel_phantom', []),
    ShipGlobals.P_SKEL_REVENANT: StateVarSetting(repairSpotNamePrefix + 'p_skel_revenant', []),
    ShipGlobals.P_SKEL_CEREBUS: StateVarSetting(repairSpotNamePrefix + 'p_skel_cerebus', []),
    ShipGlobals.QUEEN_ANNES_REVENGE: StateVarSetting(repairSpotNamePrefix + 'queenAnnesRevenge', []),
    ShipGlobals.HUNTER_VENGENCE: StateVarSetting(repairSpotNamePrefix + 'hunterVengence', []),
    ShipGlobals.HUNTER_TALLYHO: StateVarSetting(repairSpotNamePrefix + 'hunterTallyho', []) }
...
TEAM_COLOR = [
    ...
    Vec4(0.40000000000000002, 0.40000000000000002, 1.0, 1.0),
    Vec4(0.40000000000000002, 1.0, 0.40000000000000002, 1.0),
    Vec4(0.40000000000000002, 1.0, 1.0, 1.0),
    Vec4(1.0, 0.40000000000000002, 1.0, 1.0),
    Vec4(1.0, 1.0, 0.40000000000000002, 1.0),
    Vec4(0.0, 0.0, 0.0, 1.0),
    Vec4(0.5, 0.5, 0.5, 1.0),
    Vec4(1.0, 1.0, 1.0, 1.0),
    Vec4(0.20000000000000001, 0.40000000000000002, 0.40000000000000002, 1.0),
    Vec4(0.40000000000000002, 0.20000000000000001, 0.40000000000000002, 1.0),
    Vec4(0.40000000000000002, 0.40000000000000002, 0.20000000000000001, 1.0)]

def getTeamColor(team, TEAM_COLOR = TEAM_COLOR):
    return TEAM_COLOR[(team - 1) % len(TEAM_COLOR)]

SIEGE_TEAM_COLOR = [
    Vec4(0.080000000000000002, 0.28000000000000003, 0.67000000000000004, 1.0),
    Vec4(1.0, 0.80000000000000004, 0.0, 1.0)]
...
TeamBalanceValues.Ships = {
    ...
    ShipGlobals.SHIP_OF_THE_LINE: 25,
    ShipGlobals.EL_PATRONS_SHIP: 20,
    ShipGlobals.QUEEN_ANNES_REVENGE: 20,
    ShipGlobals.P_NAVY_KINGFISHER: 8,
    ShipGlobals.P_EITC_WARLORD: 20,
    ShipGlobals.P_SKEL_PHANTOM: 22,
    ShipGlobals.P_SKEL_REVENANT: 22,
    ShipGlobals.SKEL_STORM_REAPER: 22,
    ShipGlobals.SKEL_BLACK_HARBINGER: 22,
    ShipGlobals.SKEL_DEATH_OMEN: 22,
    ShipGlobals.P_SKEL_CEREBUS: 12 }
RenownWorthValues = {
    ...
    ShipGlobals.SHIP_OF_THE_LINE: 13,
    ShipGlobals.EL_PATRONS_SHIP: 10,
    ShipGlobals.QUEEN_ANNES_REVENGE: 11,
    ShipGlobals.P_NAVY_KINGFISHER: 4,
    ShipGlobals.P_EITC_WARLORD: 10,
    ShipGlobals.P_SKEL_PHANTOM: 11,
    ShipGlobals.P_SKEL_REVENANT: 11,
    ShipGlobals.SKEL_STORM_REAPER: 11,
    ShipGlobals.SKEL_BLACK_HARBINGER: 11,
    ShipGlobals.SKEL_DEATH_OMEN: 11,
    ShipGlobals.P_SKEL_CEREBUS: 6 }
