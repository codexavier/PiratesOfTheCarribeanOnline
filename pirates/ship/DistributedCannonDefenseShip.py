...
class DistributedCannonDefenseShip(DistributedNPCSimpleShip):
    ...
    def initHealthBar(self):
        self.healthBar = DirectWaitBar(frameSize = (-0.34999999999999998, 0.34999999999999998, -0.040000000000000001, 0.040000000000000001), relief = DGG.FLAT, frameColor = (0.0, 0.0, 0.0, 0.0), borderWidth = (0.0, 0.0), barColor = (0.0, 1.0, 0.0, 1.0), scale = 100)
    ...
    def initIndicatorIcons(self):
        ...
        self.goldStolenlbl = DirectLabel(parent = self.healthBar, relief = None, pos = (0, 0, 0.20000000000000001), text_align = TextNode.ACenter, text_scale = 0.5, textMayChange = 0, text = '!', text_fg = PiratesGuiGlobals.TextFG23, text_shadow = PiratesGuiGlobals.TextShadow, text_font = PiratesGlobals.getPirateBoldOutlineFont(), sortOrder = 2)
        self.goldStolenlbl.setTransparency(1)
        self.goldStolenlbl.hide()
        self.hasGoldlbl = DirectLabel(parent = self.healthBar, relief = None, pos = (0, 0, 0.34999999999999998), image = self.goldIcon, image_scale = 0.5, image_pos = (0, 0, 0), sortOrder = 2)
