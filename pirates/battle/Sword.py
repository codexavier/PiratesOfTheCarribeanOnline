...
class Sword(Weapon.Weapon):
    ...
    motion_color = {
        ...
        ItemGlobals.MotionBlurDark: [
            Vec4(1, 1, 0, 0.5),
            Vec4(0.29999999999999999, 0.29999999999999999, 0.29999999999999999, 0.5),
            Vec4(0.10000000000000001, 0.10000000000000001, 0.10000000000000001, 1.0)],
        ItemGlobals.MotionBlurGreen: [
            Vec4(0.5, 1, 0.10000000000000001, 1.0),
            Vec4(0.20000000000000001, 1, 0.20000000000000001, 1.0),
            Vec4(0.29999999999999999, 1, 0.40000000000000002, 1.0)],
        ItemGlobals.MotionBlurRed: [
            Vec4(1, 0.5, 0.20000000000000001, 1.0),
            Vec4(1, 0.29999999999999999, 0.29999999999999999, 1.0),
            Vec4(1, 0.10000000000000001, 0.10000000000000001, 1.0)] }
    walkAnim = 'walk'
    ...
    def startFlame(self, cursed = 0):
        ...
        if not self.colorIval:
            if cursed:
                self.colorIval = Sequence(self.colorScaleInterval(0.29999999999999999, Vec4(0.40000000000000002, 1, 0.34999999999999998, 1), startColorScale = Vec4(0.69999999999999996, 1, 0.59999999999999998, 1)), self.colorScaleInterval(0.29999999999999999, Vec4(0.69999999999999996, 1, 0.59999999999999998, 1)))
                self.colorIval.loop()
            else:
                self.colorIval = Sequence(self.colorScaleInterval(0.29999999999999999, Vec4(1, 0.69999999999999996, 0.40000000000000002, 1), startColorScale = Vec4(1, 0.80000000000000004, 0.59999999999999998, 1)), self.colorScaleInterval(0.29999999999999999, Vec4(1, 0.80000000000000004, 0.59999999999999998, 1)))
                self.colorIval.loop()
    ...
    def setFlameIntensity(self, value):
        if value > 0.0:
            ...
            if self.flame:
                newScale = 0.59999999999999998 + value
                scaleDiff = abs(self.flame.effectScale - newScale)
                if scaleDiff > 0.10000000000000001:
                    self.flame.setEffectScale(0.59999999999999998 + value)
    ...
    def startFrost(self):
        ...
        if not self.colorIval:
            self.colorIval = Sequence(self.colorScaleInterval(0.29999999999999999, Vec4(0.55000000000000004, 0.59999999999999998, 1, 1), startColorScale = Vec4(0.80000000000000004, 0.90000000000000002, 1, 1)), self.colorScaleInterval(0.29999999999999999, Vec4(0.80000000000000004, 0.90000000000000002, 1, 1)))
            self.colorIval.loop()
    ...
    def startThunder(self):
        ...
        if self.thunder:
            ...
            self.thunder.setColorScale(0.90000000000000002, 1, 0.59999999999999998, 1)
            self.thunder.setPos(0, 1.6000000000000001, 0)
