...
And = 'and'
SkillDescriptions = {
    InventoryType.MeleeJab: ('', '', '', '', 0),
    InventoryType.MeleePunch: ('', '', '', '', 0),
    InventoryType.MeleeKick: ('', '', '', '', 0),
    InventoryType.MeleeRoundhouse: ('', '', '', '', 0),
    InventoryType.MeleeHeadbutt: ('', '', '', '', 0),
    InventoryType.MeleeHaymaker: ('', '', '', '', 0),
    InventoryType.MeleeThrowDirt: ('', '', '', '', 0),
    InventoryType.MeleeToughness: ('', '', '', '', 0),
    InventoryType.MeleeIronSkin: ('', '', '', '', 0),
    InventoryType.MeleeDetermination: ('', '', '', '', 0),
...
CutSubtitle2_3__1 = "Oh, so you're Jack Sparrow's newest prot\x0c3\x0a9g\x0c3\x0a9, hmmm?"
...
ChatWarningFirst = 'Final Warning \x0e2\x080\x093 If you continue using inappropriate language you will be suspended. You said"%s"'
...
slant.setSlant(0.20000000000000001)
...
interfaceRed.setTextColor(0.90000000000000002, 0.40000000000000002, 0.40000000000000002, 1)
tpMgr.setProperties('Ired', interfaceRed)
darkRed = TextProperties()
darkRed.setTextColor(0.40000000000000002, 0.0, 0.0, 1)
tpMgr.setProperties('Dred', darkRed)
brightRed = TextProperties()
brightRed.setTextColor(0.90000000000000002, 0.10000000000000001, 0.10000000000000001, 1)
tpMgr.setProperties('Bred', brightRed)
interfaceBlue = TextProperties()
interfaceBlue.setTextColor(0.10000000000000001, 0.5, 1.0, 1)
tpMgr.setProperties('Iblue', interfaceBlue)
interfaceGreen = TextProperties()
interfaceGreen.setTextColor(0.10000000000000001, 1.0, 0.10000000000000001, 1)
...
guildName.setGlyphScale(0.80000000000000004)
...
WhitelistScrubList = [
    ...
    'garr',
    'arrrrr']
WhiteListWarning = 'Words typed in \x001WLEnter\x001red\x002 are shown in \x001WLDisplay\x001italics\x002 and may not be visible to some players.'
EmoteCommands = {
