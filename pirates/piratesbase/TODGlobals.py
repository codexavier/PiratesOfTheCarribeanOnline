...
SHIP_FOG_MULT = 0.10000000000000001
...
SKY_CLEARCOLORS = {
    ...
    SKY_DAWN: Vec4(0.71999999999999997, 0.71999999999999997, 0.52000000000000002, 1),
    SKY_DAY: Vec4(0.40000000000000002, 0.59999999999999998, 0.84999999999999998, 1),
    SKY_DUSK: Vec4(0.65000000000000002, 0.55000000000000004, 0.5, 1),
    SKY_NIGHT: Vec4(0.074999999999999997, 0.13, 0.26000000000000001, 1),
    SKY_STARS: Vec4(0.022499999999999999, 0.039, 0.078, 0.29999999999999999),
    SKY_HALLOWEEN: Vec4(0.074999999999999997, 0.050000000000000003, 0.12, 1),
    SKY_SWAMP: Vec4(0.20000000000000001, 0.25, 0.29999999999999999, 1),
    SKY_INVASION: Vec4(0.10000000000000001, 0.12, 0.040000000000000001, 1),
    SKY_OVERCAST: Vec4(0.34999999999999998, 0.35999999999999999, 0.38, 1),
    SKY_OVERCASTNIGHT: Vec4(0.059999999999999998, 0.11, 0.16, 1) }
SunRotationStates = {
...
CycleStateTimeList = {
    ...
    TOD_JOLLYCURSE_CYCLE: [
        (PiratesGlobals.TOD_HALFMOON, 0.050000000000000003, 0.050000000000000003),
        (PiratesGlobals.TOD_FULLMOON, 6.0, 1.95),
        (PiratesGlobals.TOD_HALFMOON2, 2, 2),
        (PiratesGlobals.TOD_HALLOWEEN, 15.949999999999999, 1)],
    TOD_JOLLYINVASION_CYCLE: [
        (PiratesGlobals.TOD_JOLLYINVASION, 24, 0.080000000000000002)],
    TOD_VALENTINE_CYCLE: [
        (PiratesGlobals.TOD_DUSK, 24, 0.080000000000000002)] }
CYCLE_NAMES = {
    TOD_ALL_CYCLE: 'All',
...
ENV_SETTINGS_AVATARCHOOSER = {
    'BASE': {
        ...
        'FrontColor': Vec4(0.90000000000000002, 0.69999999999999996, 0.80000000000000004, 1),
        'BackColor': Vec4(0.59999999999999998, 0.80000000000000004, 1.2, 1),
        'AmbientColor': Vec4(0.5, 0.80000000000000004, 1, 1),
        'FogColor': Vec4(0.14999999999999999, 0.20000000000000001, 0.34999999999999998, 0),
        'FogExp': 0.002,
        'SkyType': SKY_NIGHT,
