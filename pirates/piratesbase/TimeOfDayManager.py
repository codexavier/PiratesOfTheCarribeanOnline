...
class TimeOfDayManager(FSM.FSM, TimeOfDayManagerBase.TimeOfDayManagerBase):
    ...
    def __init__(self):
        ...
        self.accept('avatarZoneChanged', self.handleZoneChange)
    ...
    def handleZoneChange(self, av, doId, zoneId):
        if hasattr(base, 'localAvatar'):
            if av.doId == base.localAvatar.doId:
                self.setRelativeRotation()
            
        

    
    def setRelativeRotation(self):
