...
class DistributedNPCToy(DistributedInteractive.DistributedInteractive):
    ...
    def moveSelf(self, xyz):
        randX = random.random() * 0.29999999999999999 - 0.14999999999999999
        randY = random.random() * 0.29999999999999999 - 0.14999999999999999
        randZ = random.random() * 0.29999999999999999 - 0.14999999999999999
    ...
    def playInteraction(self, task = None):
        ...
        currP = currHpr[1]
        currR = currHpr[2]
        self.interactSeq = Sequence(Func(self.moveSelf, (currPosX, currPosY, currPosZ)), Wait(0.050000000000000003), Func(self.moveSelf, (currPosX, currPosY, currPosZ)), Wait(0.050000000000000003), Func(self.moveSelf, (currPosX, currPosY, currPosZ)), Wait(0.050000000000000003), Func(self.moveSelf, (currPosX, currPosY, currPosZ)), Wait(0.050000000000000003), Func(self.moveSelf, (currPosX, currPosY, currPosZ)), Wait(0.050000000000000003), Func(self.moveSelf, (currPosX, currPosY, currPosZ)), Wait(0.050000000000000003), Func(self.finishInteraction, (VBase3(currPosX, currPosY, currPosZ), (currH, currP, currR))))
