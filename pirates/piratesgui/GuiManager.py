...
class GuiManager(FSM.FSM):
    ...
    GMgrey.setGlyphShift(-0.050000000000000003)
    ...
    def __init__(self, av):
        ...
        self.warningMsg.text.setPos(0, 0, -0.48499999999999999)
        ...
        self.gameGui = GameGui.GameGui(parent = NodePath(), state = DGG.NORMAL, relief = None, pos = (-0.20000000000000001, 0, -0.27000000000000002), scale = 0.75, command = self.gameGuiPressed, frameSize = (0.0, 1.2, -0.029999999999999999, 0.34999999999999998))
        self.codeShown = 0
        self.messageStackParent = DirectFrame(parent = base.a2dBottomLeft, relief = None)
        self.messageStack = MessageStackPanel.MessageStackPanel(self.messageStackParent, relief = None, pos = (0.01, 0, 0.59999999999999998))
        self.messageStack.setBin('gui-fixed', 2)
        self._GuiManager__repValues = { }
        self.repHandlers = []
        self.chestTray = ChestTray.ChestTray(parent = NodePath(), parentMgr = self, pos = (-0.13100000000000001, 0, 0.02), sortOrder = 1)
        ...
        self.barSelection.setPos(-0.40999999999999998, 0, 0.22)
        self.barSelection.setBin('gui-popup', 0)
        self.attuneSelection = AttuneMenu()
        self.attuneSelection.setPos(-0.5, 0, -0.080000000000000002)
        goldCoin = gui.find('**/treasure_w_coin*')
        self.moneyDisplay = DirectLabel(parent = NodePath(), relief = 0, pos = (-0.32000000000000001, 0, -0.070000000000000007), scale = 2, geom = goldCoin, geom_scale = 0.17999999999999999, geom_pos = (0.059999999999999998, 0, 0.086999999999999994), text = '', text_font = PiratesGlobals.getPirateBoldOutlineFont(), text_align = TextNode.ACenter, text_scale = 0.02, text_pos = (0.059999999999999998, 0.044999999999999998), text_fg = PiratesGuiGlobals.TextFG1, text_shadow = PiratesGuiGlobals.TextShadow, textMayChange = 1)
        ...
        self.bossMeter.setPos(-0.90000000000000002, 0, -0.14999999999999999)
        self.bossMeter.setScale(1.5)
        self.bossMeter.hide()
        self.targetStatusTray = StatusTray.StatusTray(parent = NodePath(), pos = (-0.22500000000000001, 0, -0.25), showSkills = 1)
        self.targetStatusTray.hpMeter.setPos(0.040000000000000001, 0, 0.058000000000000003)
        self.targetStatusTray.voodooMeter.setPos(0.042999999999999997, 0, 0.044999999999999998)
        self.targetStatusTray.voodooMeter.setScale(0.92500000000000004, 1, 0.32500000000000001)
        self.targetStatusTray.meterChangeOffset = (-0.38750000000000001, 0, -0.192)
        self.shipIcons = loader.loadModel('models/gui/ship_battle')
        self.targetStatusTray.targetFrame2 = DirectFrame(relief = None, parent = self.targetStatusTray.hpMeter, image = self.shipIcons.find('**/ship_battle_speed_bar*'), image_scale = (0.40000000000000002, 1.0, 0.69999999999999996), pos = (0.24399999999999999, 0.0, 0.002), scale = (0.92500000000000004, 1.0, 0.32500000000000001))
        self.targetStatusTray.targetFrame = DirectFrame(relief = None, parent = self.targetStatusTray.hpMeter, image = self.shipIcons.find('**/ship_battle_speed_bar*'), image_scale = (0.42999999999999999, 1.0, 0.69999999999999996), pos = (0.24399999999999999, 0.0, 0.016))
        ...
        self.targetStatusTray.statusEffectsPanel.setScale(0.80000000000000004)
        self.targetStatusTray.statusEffectsPanel.setPos(-0.14999999999999999, 0, -0.052499999999999998)
        self.targetStatusTray.hide()
        self.targetStatusTray.enemyFrame = DirectFrame(relief = None, parent = self.targetStatusTray, image = self.shipIcons.find('**/ship_battle_dish02*'), image_scale = (0.34999999999999998, 0.34999999999999998, 0.34999999999999998), pos = (-0.25, 0.0, -0.17249999999999999))
        self.shipTargetPanel = None
        self.socialPanel = SocialPanel.SocialPanel()
        self.socialPanel.setPos(-0.56999999999999995, 0.0, 0.17000000000000001)
        ...
        self.oceanMsg = DirectFrame(parent = self.gameGui, relief = None, text = 'Ocean Zone', text_fg = PiratesGuiGlobals.TextFG2, text_scale = 0.40000000000000002, text_font = PiratesGlobals.getPirateOutlineFont(), text_shadow = PiratesGuiGlobals.TextShadow, text_align = TextNode.ACenter, frameSize = (-1, 1, -0.5, 0.5), frameColor = (0.5, 0.5, 0.5, 1.0), pos = (2.0, 0, -0.29999999999999999))
        self.oceanMsg.setScale(0.10000000000000001)
        self.oceanMsg.hide()
        self.pvpPanel = None
        self.pvpStatus = None
        ...
        self.secondarytitler.text.setPos(0, 0, -0.10000000000000001)
        ...
        self.dialogSubtitler.text.setPos(-0.48999999999999999, 0, -0.55000000000000004)
        ...
        self.dialogSubtitler.confirmButton['image_scale'] = (0.59999999999999998, 0.59999999999999998, 0.59999999999999998)
        self.dialogSubtitler.confirmButton.setPos(0.20000000000000001, 0, -0.70999999999999996)
        self.dialogSubtitler.confirmButton.setBin('gui-fixed', 1)
        self.interactionalSubtitler = Subtitler()
        self.progressMsg = TextPrinter()
        self.progressMsg.text.setPos(0, 0, 0.29999999999999999)
        ...
        self.setUIScale(base.options.gui_scale * 0.59999999999999998 + 0.69999999999999996)
        ...
        self.iMBsizeX = 0.95999999999999996
        self.iMBsizeZ = 0.17000000000000001
        iMBmodelName = 'pir_m_gui_frm_subframe'
        iMBimageColorScale = VBase4(0.75, 0.75, 0.90000000000000002, 1.0)
        self.iMBtextScale = 0.044999999999999998
        iMBframeSize = (-0.0 * self.iMBsizeX, 1.0 * self.iMBsizeX, -0.0 * self.iMBsizeZ, 1.0 * self.iMBsizeZ)
        self.instructionMessageBoxText = BorderFrame(parent = base.a2dBottomCenter, frameSize = iMBframeSize, modelName = iMBmodelName, imageColorScale = iMBimageColorScale, pos = (self.iMBsizeX * -0.5, 0, 0.29999999999999999), textMayChange = 1, text = '', text_scale = self.iMBtextScale, text_align = TextNode.ACenter, text_pos = (self.iMBsizeX * 0.5, 0.089999999999999997), text_fg = PiratesGuiGlobals.TextFG1, text_shadow = (0, 0, 0, 1), text_wordwrap = self.iMBsizeX * 0.90000000000000002 / self.iMBtextScale, text_font = PiratesGlobals.getInterfaceFont())
        self.instructionMessageBoxText.hide()
        self.instructionMessageText = DirectLabel(parent = base.a2dBottomCenter, pos = (self.iMBsizeX * -0.5, 0, 0.29999999999999999), textMayChange = 1, text = '', text_scale = self.iMBtextScale, text_align = TextNode.ACenter, text_pos = (self.iMBsizeX * 0.5, 0.089999999999999997), text_fg = PiratesGuiGlobals.TextFG1, text_shadow = (0, 0, 0, 1), text_wordwrap = self.iMBsizeX * 0.90000000000000002 / self.iMBtextScale, text_font = PiratesGlobals.getInterfaceFont())
    ...
    def doInstructionMessageQueue(self, task = None):
        ...
        if len(self.instructionMessageQueue) > 0:
            ...
            self.instructionMessageText['text_wordwrap'] = self.iMBsizeX * 0.90000000000000002 / msgCatInfo['text_scale']
            if messageImage:
                self.instructionMessageIcon['image'] = messageImage
                self.instructionMessageIcon['image_scale'] = messageImageScale * 0.14999999999999999
                self.instructionMessageIcon['image_pos'] = (0.080000000000000002, 0.0, self.iMBsizeZ * 0.5)
                self.instructionMessageIcon.show()
                self.instructionMessageText['text_pos'] = (self.iMBsizeX * 0.56999999999999995, 0.12)
                self.instructionMessageText['text_wordwrap'] = self.iMBsizeX * 0.80000000000000004 / msgCatInfo['text_scale']
            else:
    ...
    def showInjuredGui(self):
        ...
        if self.injuredGui:
            ...
            down_geom = gui2.find('**/but_nav_down')
            dsbl_geom = gui2.find('**/but_nav_disabled')
            self.injuredGui = DirectFrame(parent = base.a2dBottomRight, relief = None, pos = (-0.40000000000000002, 0, 0.29999999999999999))
            self.gotoJailText = DirectLabel(parent = self.injuredGui, relief = None, frameSize = (-0.25, 0.25, -0.25, 0.25), image = topGui.find('**/pir_t_gui_gen_parchment'), image_scale = (0.34499999999999997, 0, 0.46500000000000002), scale = 1.0, text = PLocalizer.InjuredOrHelp, text_fg = PiratesGuiGlobals.TextFG0, text_font = PiratesGlobals.getPirateFont(), text_scale = 0.040000000000000001, text_wordwrap = 13, text_pos = (0, 0.070000000000000007))
            defeatedText = DirectLabel(parent = self.gotoJailText, relief = None, scale = 1.0, text = PLocalizer.InjuredDefeated, text_fg = PiratesGuiGlobals.TextFG23, text_font = PiratesGlobals.getPirateFont(), text_scale = 0.050000000000000003, text_wordwrap = 12, text_pos = (0, 0.12))
            self.gotoJailButton = DirectButton(parent = self.injuredGui, relief = None, geom = (norm_geom, down_geom, over_geom), pos = (0.0, 0, -0.080000000000000002), scale = 0.65000000000000002, command = self.askForJail, text = PLocalizer.InjuredGotoJail, text_fg = PiratesGuiGlobals.TextFG2, text_font = PiratesGlobals.getPirateBoldOutlineFont(), text_scale = 0.070000000000000007, text_wordwrap = 9, text_pos = (0, -0.02))
    ...
    def createLevelUpText(self):
        ...
        self.levelUpLabel = DirectLabel(parent = self.levelUpText, relief = None, text = '', text_font = PiratesGlobals.getPirateOutlineFont(), text_fg = (0.10000000000000001, 0.69999999999999996, 0.10000000000000001, 1), scale = 0.25)
    ...
    def showLevelUpText(self, category, level):
        ...
        if category == InventoryType.OverallRep:
            self.levelUpCategoryLabel['text_fg'] = (1.0, 1.0, 0.20000000000000001, 1)
            self.levelUpLabel['text_fg'] = (1.0, 1.0, 0.10000000000000001, 1)
        elif category == InventoryType.PVPTotalInfamyLand or category == InventoryType.PVPTotalInfamySea:
            self.levelUpCategoryLabel['text_fg'] = (1.0, 0.20000000000000001, 0.20000000000000001, 1)
            self.levelUpLabel['text_fg'] = (1.0, 0.10000000000000001, 0.10000000000000001, 1)
    ...
    def setTimer(self, time, showMinutes = 1, mode = None, titleText = '', titleFg = None, infoText = '', cancelText = '', cancelCallback = None, timerExpiredCallback = None, alarmTime = 5):
        ...
        self.timer.setPos(0.32000000000000001, 0, 1.2)
        self.timer.show()
    ...
    def setHourglassTimer(self, time, showMinutes = 1, mode = None, titleText = '', titleFg = None, infoText = '', cancelText = '', cancelCallback = None, timerExpiredCallback = None):
        ...
        timer.setScale(0.20000000000000001)
        timer.show()
        if timerExpiredCallback:
    ...
    def createInteractionalSubtitle(self, text, avatar, audio = None, color = None):
        ...
        if self.bg == None:
            ...
            self.bg.setColorScale(1, 1, 1, 0.84999999999999998)
            self.bg.setScale(0.32000000000000001, 0.032000000000000001, 0.20000000000000001)
    ...
    def loadOffscreenHitEffects(self):
        ...
        left.setScale(4, 0, 9)
        left.setPosHpr(0.20000000000000001, 0, 0, 0, 0, 0)
        left.hide()
        left.flattenStrong()
        ...
        right.setPosHpr(-0.20000000000000001, 0, 0, 0, 0, 180)
        right.hide()
        right.flattenStrong()
        ...
        self.offscreenHitEffects = [
            ...
            right,
            top]
        flashLeft = Sequence(Func(left.show), LerpColorInterval(left, 0.20000000000000001, onColor, offColor), LerpColorInterval(left, 0.40000000000000002, offColor, onColor), Func(left.hide))
        flashRight = Sequence(Func(right.show), LerpColorInterval(right, 0.20000000000000001, onColor, offColor), LerpColorInterval(right, 0.40000000000000002, offColor, onColor), Func(right.hide))
        flashBottom = Sequence(Func(bottom.show), LerpColorInterval(bottom, 0.20000000000000001, onColor, offColor), LerpColorInterval(bottom, 0.40000000000000002, offColor, onColor), Func(bottom.hide))
        flashTop = Sequence(Func(top.show), LerpColorInterval(top, 0.20000000000000001, onColor, offColor), LerpColorInterval(top, 0.40000000000000002, offColor, onColor), Func(top.hide))
    ...
    def createLookoutPopup(self):
        ...
        self.lookoutPopup2DNode.setPosHprScale(-0.59999999999999998, 0, 0.17999999999999999, 0, 0, 0, 0.040000000000000001, 0.040000000000000001, 0.040000000000000001)
        self.lookoutPopup2DNode.setColorScale(0.92000000000000004, 0.81999999999999995, 0.65000000000000002, 1.0)
    ...
    def loadPirateCode(self):
        ...
        codeMessage2 = DirectLabel(parent = self.pirateCode, relief = None, text = PLocalizer.PirateCodeWarning2, text_fg = (1, 1, 1, 1), text_shadow = (0, 0, 0, 1), pos = (0.48999999999999999, 0, 0.089999999999999997), text_scale = 0.080000000000000002)
    ...
    def disableLookoutPanel(self, disable):
        if disable:
            ...
            self.chestTray.lookoutButton['image3_color'] = VBase4(0.40000000000000002, 0.40000000000000002, 0.40000000000000002, 1)
    ...
    def createReceiveEffect(self, uiItem, explain = False):
        ...
        if explain:
            ...
            finalPos = Point3(-0.80000000000000004, 0, -1.0)
            startScale = uiItem.getScale()
            finalScale = Point3(2, 2, 2)
            displayIval.append(Func(uiItem.hideMinimapObjects))
        else:
            startPos = uiItem.getPos()
            finalPos = Point3(-0.40000000000000002, 0, -0.40000000000000002)
            startScale = uiItem.getScale()
            finalScale = Point3(1.0, 1.0, 1.0)
        receiveDelay = 0.34999999999999998
        placeDelay = 0.69999999999999996
    ...
    def flashOceanMsg(self, oceanZoneName):
        ...
        self.oceanMsg.setScale(0.10000000000000001, 0.10000000000000001, 0.10000000000000001)
    ...
    def createPreviewTag(self):
        ...
        self.titleText1 = DirectLabel(parent = self.prevTag, relief = None, text = PLocalizer.PreviewTitle1, text_align = TextNode.ACenter, text_scale = 0.089999999999999997, text_fg = PiratesGuiGlobals.TextFG1, text_font = PiratesGlobals.getPirateFont(), text_shadow = PiratesGuiGlobals.TextShadow, pos = (0.0, 0, 0.080000000000000002))
        self.titleText2 = DirectLabel(parent = self.prevTag, relief = None, text = PLocalizer.PreviewTitle2, text_align = TextNode.ACenter, text_scale = 0.070000000000000007, text_fg = PiratesGuiGlobals.TextFG1, text_font = PiratesGlobals.getPirateFont(), text_shadow = PiratesGuiGlobals.TextShadow, pos = (0.0, 0, -0.01))
        norm_geom = gui2.find('**/but_nav')
        over_geom = gui2.find('**/but_nav_over')
        down_geom = gui2.find('**/but_nav_down')
        dsbl_geom = gui2.find('**/but_nav_disabled')
        self.upgradeButton = DirectButton(parent = self.prevTag, relief = None, geom = (norm_geom, down_geom, over_geom), pos = (0.0, 0, -0.11), scale = 0.80000000000000004, command = base.popupBrowser, extraArgs = [
