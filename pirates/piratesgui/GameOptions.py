...
class Options(OptionSpace):
    ...
    def load(self, file_path):
        ...
        try:
            ...
            self.land_map_radar_axis = self.validate(int, 'land_map_radar_axis', self.RadarAxisMap, [
                self.RadarAxisMap,
                self.RadarAxisCamera])
            self.ocean_map_radar_axis = self.validate(int, 'ocean_map_radar_axis', self.RadarAxisCamera, [
                self.RadarAxisMap,
                self.RadarAxisCamera])
        ...
        if di.getDisplayState() == DisplayInformation.DSSuccess:
            ...
            if vendor_id == 4098:
                ati_device_list = [
                    ...
                    [
                        0,
                        'Rage 128 PRO ULTRA Video Controller',
                        21574],
                    [
                        'AMD Stream Processor',
                        29262],
                    [
                        'AMD Stream Processor Secondary',
                        29294],
                    [
                    ...
                    [
                        1,
                        'ATI Mobility Radeon HD 2600 XT Gemini',
                        38283],
                    [
                        1,
                        'ATI Radeon 2100',
                    ...
                    [
                        ...
                        22095],
                    [
                        'ATI Radeon X700 Series Secondary',
                        22127],
                    [
                        1,
                    ...
                    [
                        1,
                        'Radeon X1950 CrossFire Edition Secondary',
                        29280],
                    [
                        1,
                        'Radeon X1950 Series Secondary  ',
                    ...
                    [
                        ...
                        24138],
                    [
                        'Radeon X700 XT Secondary',
                        24170],
                    [
                        'Radeon X700/X550 Series',
                        24143],
                    [
                        'Radeon X700/X550 Series Secondary',
                        24175],
                    [
                        1,
                        'Radeon X800 GT',
            ...
            if vendor_id == 4318:
                nvidia_device_list = [
                    [
                        0,
                        45,
                        'NV5 TNT2 Model 64 / TNT2 Model 64 Pro'],
                    [
                        0,
                        272,
                        'GeForce2 MX/MX 400'],
            ...
            if vendor_id == 32902:
                intel_device_list = [
                    ...
                    [
                        ...
                        10643],
                    [
                        'GM965 Device 0 / X3100',
                        10754],
                    [
                        'GM965 Device 1 / X3100',
                        10755],
                    [
                        'G965 Device 0 / X3000',
                        10658],
    ...
    def simplify(self):
        ...
        elif self.character_detail_level == Options.option_low:
            self.simple_display_option = 0
        ...
        if self.simple_display_option == 2:
            ...
            self.shader = 1
            self.shadow = 1
        elif self.simple_display_option == 1:
            self.character_detail_level = Options.option_medium
            self.terrain_detail_level = Options.option_medium
...
class GameOptions(BorderFrame):
    ...
    def reflection_off_button_function(self):
        ...
        messenger.send('options_reflections_change', [
            0])
        self.update()
