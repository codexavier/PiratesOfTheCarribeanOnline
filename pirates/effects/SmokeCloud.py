...
class SmokeCloud(PooledEffect, EffectController):
    ...
    def __init__(self):
        ...
        self.p0.renderer.setInitialXScale(0.070000000000000007 * self.spriteScale * self.cardScale)
        self.p0.renderer.setFinalXScale(0.22 * self.spriteScale * self.cardScale)
        self.p0.renderer.setInitialYScale(0.070000000000000007 * self.spriteScale * self.cardScale)
