...
class DistributedGameArea(DistributedNode.DistributedNode, MappableArea):
    ...
    handleChildArrive = report(types = [
        'frameCount',
        'args'], dConfigParam = 'minimap')(handleChildArrive)
    ...
    handleChildLeave = report(types = [
        'frameCount',
        'args'], dConfigParam = 'minimap')(handleChildLeave)
    ...
    def loadConnectors(self):
        for link in self.links:
            ...
            connectorId not in self.connectorInterests
    ...
    reparentConnector = report(types = [
        'frameCount',
        'args'], dConfigParam = [
        'jail',
        'teleport'])(reparentConnector)
    ...
    quickLoadOtherSide = report(types = [
        'frameCount',
        'args'], dConfigParam = [
        'jail',
        'teleport'])(quickLoadOtherSide)
    ...
    _getTunnelSpawnPos = report(types = [
        'args'], dConfigParam = 'teleport')(_getTunnelSpawnPos)
    ...
    hideMapNodes = report(types = [
        'frameCount',
        'args'], dConfigParam = 'minimap')(hideMapNodes)
    ...
    setMinimapPrefix = report(types = [
        'frameCount',
        'args'], dConfigParam = 'minimap')(setMinimapPrefix)
    ...
    getMapNode = report(types = [
        'frameCount',
        'args'], dConfigParam = 'minimap')(getMapNode)
    ...
    addMinimapObject = report(types = [
        'frameCount',
        'args'], dConfigParam = 'minimap')(addMinimapObject)
    ...
    removeMinimapObject = report(types = [
        'frameCount',
        'args'], dConfigParam = 'minimap')(removeMinimapObject)
    ...
    setMinimapArea = report(types = [
        'args'], dConfigParam = 'minimap')(setMinimapArea)
    
    def showTunnelOnMinimap(self, tunnelUid):
        return self.builder.getTunnelMinimap(tunnelUid) == self.minimapArea

    showTunnelOnMinimap = report(types = [
        'frameCount',
        'args'], dConfigParam = 'minimap')(showTunnelOnMinimap)
