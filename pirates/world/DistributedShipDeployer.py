...
s % numSpheres(xrange(sphereId - padding, sphereId + padding + 1)):
    ...
    handleShipEnterSoftBarrier = report(types = [
        'frameCount',
        'args'], dConfigParam = 'shipboard')(handleShipEnterSoftBarrier)
    ...
    handleShipExitSoftBarrier = report(types = [
        'frameCount',
        'args'], dConfigParam = 'shipboard')(handleShipExitSoftBarrier)
    ...
    handleShipEnterHardBarrier = report(types = [
        'frameCount',
        'args'], dConfigParam = 'shipboard')(handleShipEnterHardBarrier)
    ...
    handleShipExitHardBarrier = report(types = [
        'frameCount',
        'args'], dConfigParam = 'shipboard')(handleShipExitHardBarrier)
