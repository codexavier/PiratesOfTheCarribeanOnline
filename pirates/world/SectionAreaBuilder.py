...
class SectionAreaBuilder(AreaBuilderBase):
    ...
    createSection = report(types = [
        'args'], dConfigParam = 'minimap')(createSection)
    ...
    setupCollisionSections = report(types = [
        'args'], dConfigParam = 'minimap')(setupCollisionSections)
    ...
    addLargeObj = report(types = [
        'args'], dConfigParam = 'minimap')(addLargeObj)
    ...
    addSectionObj = report(types = [
        'args'], dConfigParam = 'minimap')(addSectionObj)
    ...
    def isVisible(self, data):
        if not (self.visZone) and not data or not (self.visTable):
            return True
    ...
    addEffectObject = report(types = [
        'args'], dConfigParam = 'minimap')(addEffectObject)
