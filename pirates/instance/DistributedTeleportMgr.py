...
class DistributedTeleportMgr(DistributedObject.DistributedObject):
    ...
    def localTeleportConfirmation(self, confirmed):
        if confirmed:
            ...
            self.localTeleport(*requestData[0], **requestData[0])
    ...
    localTeleportEffect = report(types = [
        'args',
        'deltaStamp'], dConfigParam = 'teleport')(localTeleportEffect)
    ...
    localTeleportPos = report(types = [
        'args',
        'deltaStamp'], dConfigParam = 'teleport')(localTeleportPos)
    ...
    localTeleport = report(types = [
        'args',
        'deltaStamp'], dConfigParam = 'teleport')(localTeleport)
    ...
    localTeleportToId = report(types = [
        'args',
        'deltaStamp'], dConfigParam = [
        'teleport',
        'shipboardreport'])(localTeleportToId)
    ...
    _localTeleportToIdResponse = report(types = [
        'args',
        'deltaStamp'], dConfigParam = [
        'teleport',
    ...
    def _localTeleportToIdInterestComplete(self):
        ...
        if isAShip:
            ...
            if self.localTeleportingObj == base.localAvatar:
                self.localTeleportingObj.spawnWiggle()
    ...
    _localTeleportToIdInterestComplete = report(types = [
        'args',
        'deltaStamp'], dConfigParam = [
        'teleport',
        'shipboardreport'])(_localTeleportToIdInterestComplete)
    ...
    _localTeleportToIdDone = report(types = [
        'args',
        'deltaStamp'], dConfigParam = [
        'teleport',
        'shipboardreport'])(_localTeleportToIdDone)
    ...
    requestTeleportToAvatar = report(types = [
        'args',
        'deltaStamp'], dConfigParam = [
        'teleport'])(requestTeleportToAvatar)
    ...
    def requestTeleportToIsland(self, islandUid):
        ...
        if not launcher.canLeaveFirstIsland():
            base.cr.centralLogger.writeClientEvent('Player encountered phase 4 blocker trying to teleport to another island')
    ...
    requestTeleportToIsland = report(types = [
        'args',
        'deltaStamp'], dConfigParam = [
        'teleport'])(requestTeleportToIsland)
    ...
    islandTeleportConfirmation = report(types = [
        'args',
        'deltaStamp'], dConfigParam = [
        'teleport'])(islandTeleportConfirmation)
    ...
    teleportToIslandResponse = report(types = [
        'args',
        'deltaStamp'], dConfigParam = [
        'teleport'])(teleportToIslandResponse)
    ...
    stowawayTeleportResponse = report(types = [
        'args',
        'deltaStamp'], dConfigParam = [
        'teleport'])(stowawayTeleportResponse)
    ...
    queryAvatarForTeleport = report(types = [
        'args',
        'deltaStamp'], dConfigParam = [
        'teleport'])(queryAvatarForTeleport)
    ...
    handleAvatarTeleportQuery = report(types = [
        'args',
        'deltaStamp'], dConfigParam = 'teleport')(handleAvatarTeleportQuery)
    ...
    handleAvatarTeleportResponse = report(types = [
        'args',
        'deltaStamp'], dConfigParam = [
        'teleport'])(handleAvatarTeleportResponse)
    ...
    initiateTeleport = report(types = [
        'args',
        'deltaStamp'], dConfigParam = 'teleport')(initiateTeleport)
    ...
    setTeleportQueryId = report(types = [
        'args',
        'deltaStamp'], dConfigParam = 'teleport')(setTeleportQueryId)
    
    def clearTeleportQueryId(self):
        self.teleportQueryId = 0

    clearTeleportQueryId = report(types = [
        'args',
    ...
    initiateTeleportAI = report(types = [
        'args',
        'deltaStamp'], dConfigParam = 'teleport')(initiateTeleportAI)
    ...
    teleportInit = report(types = [
        'args',
        'deltaStamp'], dConfigParam = 'teleport')(teleportInit)
    ...
    teleportHasBegun = report(types = [
        'args',
        'deltaStamp'], dConfigParam = 'teleport')(teleportHasBegun)
    ...
    forceTeleportStart = report(types = [
        'args',
        'deltaStamp'], dConfigParam = 'teleport')(forceTeleportStart)
    ...
    teleportAddInterestCompleteTZ = report(types = [
        'args',
        'deltaStamp'], dConfigParam = 'teleport')(teleportAddInterestCompleteTZ)
    ...
    teleportZoneExists = report(types = [
        'args',
        'deltaStamp'], dConfigParam = 'teleport')(teleportZoneExists)
    ...
    teleportHandlerExists = report(types = [
        'args',
    ...
    localAvTeleportFinishedRequest = report(types = [
        'args',
        'deltaStamp'], dConfigParam = 'teleport')(localAvTeleportFinishedRequest)
    ...
    createSpawnInterests = report(types = [
        'args',
