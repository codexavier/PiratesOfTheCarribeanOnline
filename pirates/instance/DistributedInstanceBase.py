...
class DistributedInstanceBase(DistributedObject, WorldNode):
    ...
    setSpawnInfo = report(types = [
        'deltaStamp',
        'args'], dConfigParam = ('jail', 'teleport'))(setSpawnInfo)
    ...
    def sendLocalAvatarToJail(self, jailDoId, jailWorldParentId, jailWorldZone):
        ...
        if jailDoId == 0 and jailWorldParentId == 0 and jailWorldZone == 0:
            ...
            loadJailWorld = report(types = [
                'frameCount'], dConfigParam = 'jail')(loadJailWorld)
            ...
            jailAreaLoaded = report(types = [
                'frameCount'], dConfigParam = 'jail')(jailAreaLoaded)
    ...
    sendLocalAvatarToJail = report(types = [
        'frameCount',
        'args'], dConfigParam = 'jail')(sendLocalAvatarToJail)
