...
class DistributedQuestProp(DistributedBattleable.DistributedBattleable, Lootable.Lootable):
    ...
    def setCurrentDepth(self, depth):
        oldZ = (self.currentDepth / float(self.startingDepth)) * -2.6000000000000001
        self.currentDepth = depth
        z = (self.currentDepth / float(self.startingDepth)) * -2.6000000000000001
        dirtZ = min(z + 0.5, -1.5)
    ...
    def setOnFire(self, duration):
        ...
        if self.fireEffect:
            ...
            self.fireEffect.effectScale = 0.10000000000000001 * effectScale
