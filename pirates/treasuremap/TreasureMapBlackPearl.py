...
class TreasureMapBlackPearl(DistributedTreasureMapInstance.DistributedTreasureMapInstance):
    ...
    __init__ = report(types = [
        'frameCount',
        'deltaStamp',
        'args'], dConfigParam = 'blackpearl')(__init__)
    ...
    delete = report(types = [
        'frameCount',
        'deltaStamp',
        'args'], dConfigParam = 'blackpearl')(delete)
    ...
    announceGenerate = report(types = [
        'frameCount',
        'deltaStamp',
        'args'], dConfigParam = 'blackpearl')(announceGenerate)
    ...
    tryToStartCutscene = report(types = [
        'frameCount',
        'deltaStamp',
        'args'], dConfigParam = 'blackpearl')(tryToStartCutscene)
    
    def _TreasureMapBlackPearl__requestState(self, state):
    ...
    def setFortIds(self, fortIds):
        ...
        self.cr.relatedObjectMgr.abortRequest(self.fortRequest)
        self.fortRequest = self.cr.relatedObjectMgr.requestObjects(self.fortIds, eachCallback = self._TreasureMapBlackPearl__gotOneFort)

    setFortIds = report(types = [
        'frameCount',
        'deltaStamp',
        'args'], dConfigParam = 'blackpearl')(setFortIds)
    
    def _TreasureMapBlackPearl__gotOneFort(self, fort):
    ...
    setState = report(types = [
        'frameCount',
        'deltaStamp',
        'args'], dConfigParam = 'blackpearl')(setState)
    
    def setBlackPearlId(self, doId):
        self.pearlId = doId
        self._TreasureMapBlackPearl__gotPearl(base.cr.doId2do.get(doId))
        if not self.pearl:
            self.cr.relatedObjectMgr.abortRequest(self.pearlRequest)
            self.pearlRequest = self.cr.relatedObjectMgr.requestObjects([
                self.pearlId], eachCallback = self._TreasureMapBlackPearl__gotPearl)
    ...
    def _TreasureMapBlackPearl__gotPearl(self, pearl):
        self.pearlRequest = None
        self.pearl = pearl
        if pearl:
    ...
    def _TreasureMapBlackPearl__gotGoliath(self, goliath):
    ...
    def setGoliathId(self, doId):
        ...
        if not self.goliath:
            base.cr.relatedObjectMgr.requestObjects([
                self.goliathId], allCallback = self._TreasureMapBlackPearl__gotGoliath)
    ...
    def setAttackShipIds(self, shipIds):
        ...
        self.attackShipRequest = self.cr.relatedObjectMgr.requestObjects(self.attackShipIds, eachCallback = self._TreasureMapBlackPearl__gotOneAttackShip)

    
    def _TreasureMapBlackPearl__gotOneAttackShip(self, attackShip):
    ...
    customTimeOfDayOff = report(types = [
        'frameCount',
        'deltaStamp',
        'args'], dConfigParam = 'blackpearl')(customTimeOfDayOff)
    
    def customTimeOfDayOn(self):
        base.cr.timeOfDayManager.setEnvironment(TODGlobals.ENV_EVER_NIGHT, { })

    customTimeOfDayOn = report(types = [
        'frameCount',
        'deltaStamp',
        'args'], dConfigParam = 'blackpearl')(customTimeOfDayOn)
    ...
    def showRulesPanel(self, stage):
        ...
        self.messageHolder.setPos(Vec3(0, 0, 0.84999999999999998))
    ...
    def _startFog(self):
        ...
        self._fog.p0.renderer.getColorInterpolationManager().addConstant(0.0, 1.0, Vec4(0.90000000000000002, 0.90000000000000002, 0.90000000000000002, 0.40000000000000002), 1)
    ...
    enterWaitClientsReady = report(types = [
        'frameCount',
        'deltaStamp',
        'args'], dConfigParam = 'blackpearl')(enterWaitClientsReady)
    
    def exitWaitClientsReady(self):
        base.transitions.fadeIn()

    exitWaitClientsReady = report(types = [
        'frameCount',
        'deltaStamp',
        'args'], dConfigParam = 'blackpearl')(exitWaitClientsReady)
    ...
    enterStageOne = report(types = [
        'frameCount',
        'deltaStamp',
        'args'], dConfigParam = 'blackpearl')(enterStageOne)
    ...
    def playCutscene(self):
        ...
        f = render.getFog()
        if f:
            f.setExpDensity(0.00029999999999999997)
    ...
    exitStageOne = report(types = [
        'frameCount',
        'deltaStamp',
        'args'], dConfigParam = 'blackpearl')(exitStageOne)
    ...
    stageOneCutsceneDone = report(types = [
        'frameCount',
        'deltaStamp',
        'args'], dConfigParam = 'blackpearl')(stageOneCutsceneDone)
    ...
    handleShipCapture = report(types = [
        'frameCount',
        'deltaStamp',
        'args'], dConfigParam = 'blackpearl')(handleShipCapture)
    ...
    handleBoardedPearl = report(types = [
        'frameCount',
        'deltaStamp',
        'args'], dConfigParam = 'blackpearl')(handleBoardedPearl)
    ...
    enterStageTwo = report(types = [
        'frameCount',
        'deltaStamp',
        'args'], dConfigParam = 'blackpearl')(enterStageTwo)
    
    def exitStageTwo(self):
        self.camIval.finish()

    exitStageTwo = report(types = [
        'frameCount',
        'deltaStamp',
        'args'], dConfigParam = 'blackpearl')(exitStageTwo)
    ...
    def fireShipCannonsAtTarget(self, ship, target):
        ...
        for cannonData in ship.cannons.values():
            ...
            if relPos[1] > 0:
                delay = random.random()
                if delay < 0.90000000000000002:
                    taskMgr.doMethodLater(delay, self.fireCannon, 'fireNPCCannon', extraArgs = [
                        cannon])
                    taskMgr.doMethodLater(2 * delay, self.fireCannon, 'fireNPCCannon', extraArgs = [
                        cannon])
                    taskMgr.doMethodLater(3 * delay, self.fireCannon, 'fireNPCCannon', extraArgs = [
                        cannon])
    ...
    def queryReadyForStageThree(self):
        ...
        if allReady:
            ...
            self.stageThreeDelayedCall = DelayedCall(Functor(self.queryReadyForStageThree), delay = 0.10000000000000001)
    ...
    enterStageThree = report(types = [
        'frameCount',
        'deltaStamp',
        'args'], dConfigParam = 'blackpearl')(enterStageThree)
    ...
    def getBarricadeWarning(self):
        retval = -1
        if retval == -1:
            if not 0 in self.barricadesDestroyed:
                pass
            if not (1 in self.barricadesDestroyed):
                retval = 1
    ...
    setAllPlayersReady = report(types = [
        'frameCount',
        'deltaStamp',
        'args'], dConfigParam = 'blackpearl')(setAllPlayersReady)
