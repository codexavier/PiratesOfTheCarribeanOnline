...
class InventoryType:
    ...
    getIslandUidFromTeleportToken = classmethod(getIslandUidFromTeleportToken)
    ...
    Collection_Sets = (Collection_Set1, Collection_Set2, Collection_Set3, Collection_Set4, Collection_Set5, Collection_Set6, Collection_Set7, Collection_Set8, Collection_Set9, Collection_Set10, Collection_Set11)
    UberDogRev = 15999
